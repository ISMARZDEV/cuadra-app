...
_PROMPT = """Suggest 2-3 spending categories for this expense, each with ONE emoji that fits it.
Expense: merchant="{merchant}", current category="{category}", amount={amount}.
