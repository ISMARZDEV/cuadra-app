...
// Dev login — exchanges a seeded email for a JWT (cuadra-mobile skill §4). Used only when Clerk
// is NOT configured (dual-mode fallback for local dev). Prod uses <ClerkLoginScreen/> (AuthView).
