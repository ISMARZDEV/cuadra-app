...
describe("SourcesScreen", () => {
  ...
  it("creates a new source from the form and calls the api wrapper with its values", async () => {
    mockData = { sources: [] };
  ...
  it("pauses an active source via the api wrapper", async () => {
  ...
  it("resumes a paused source via the api wrapper", async () => {
