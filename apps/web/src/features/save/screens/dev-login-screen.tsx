...
// se obtiene el MISMO user_id → las alertas se comparten entre app y web. Fallback dual-mode:
// se usa sólo cuando Clerk NO está configurado (dev local). Prod usa <ClerkLoginScreen/> (<SignIn/>).
