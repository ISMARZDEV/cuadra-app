...
// Todas las categorías (Imagen #6): sidebar + grid de categorías tope. Cada card lleva a su página
// de categoría (breadcrumb + subcategorías). Datos reales (taxonomía del backend).
