...
En el iPhone/iPad (misma Wi-Fi): abrí la app **Cuadra** → dev-client → conectá a `IP:8087` →
...
Procesos que deja corriendo `dev-up.sh`: Postgres (`cuadra-db`), API (`:8005`), Metro (`:8087`).
