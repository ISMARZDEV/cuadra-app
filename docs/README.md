# 📚 Cuadra — Documentación

Documentación arquitectónica del proyecto. **Fuente de verdad: `arquitectura-mvp.md`.**

| Documento | Qué es |
|---|---|
| [`arquitectura-mvp.md`](./arquitectura-mvp.md) | **Padre.** Arquitectura de solución del MVP + fases · ADRs 1-33 |
| [`arquitectura-explicada.md`](./arquitectura-explicada.md) | La arquitectura en lenguaje simple (analogías + glosario) |
...
> Convención: **código en inglés, prosa en español** (ADR 32).
