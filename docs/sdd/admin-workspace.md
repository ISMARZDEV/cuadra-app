...
- **Batch 5 — Toolbar**: search + filtros + view-toggle + dropdowns "Mostrar todos"/"Acciones" + export, fiel al Figma.
- **Batch 6 — Restyle tabla**: `ReviewQueueListScreen` con `Table` + columnas del Figma + paginación numerada + `useAdminList` + i18n.
- **Batch 7 — VERIFY**: suite backend + web verdes, typecheck, smoke visual del usuario vs Figma.
